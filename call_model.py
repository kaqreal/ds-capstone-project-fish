...
def classify(model_folder, image_input):
    ...
    img_dir = 'data/fish_examples/' + image_input
...
def main():
    model_folder = input("Which model would you like to use? (saved model folder inside /models):")
    image_input= input('Please specify an image file (img file inside data/fish_examples folder):')
